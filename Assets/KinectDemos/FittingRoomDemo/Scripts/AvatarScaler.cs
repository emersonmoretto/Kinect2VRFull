...
public class AvatarScaler : MonoBehaviour 
{
	...
	// additional body part scale factors that might be used for fine tuning
	public float bodyScaleFactor = 1.03f;
	public float armScaleFactor = 1.0f;
	public float legScaleFactor = 0.9f;
	
	// Whether the scaling is invoked on each Update or not. Default false.
	public bool continuousScaling = false;
	
	// The smooth factor used in case of continuous scaling
	public float smoothFactor = 5f;

	// gui text for debugging purposes
...
//			return;
		...
		SetupBoneScale(leftElbowScaleTransform, modelRightElbowScale, modelLeftLowerArmLength, 
